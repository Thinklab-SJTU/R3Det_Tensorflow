...
def eval(num_imgs, args):
    ...
    r3det_plusplus = build_whole_network_r3det_plusplus.DetectionNetwork(base_network_name=cfgs.NET_NAME,
                                                                         is_training=False)
    test_dota(det_net=r3det_plusplus, real_test_img_list=real_test_img_list, args=args, txt_name=txt_name)
