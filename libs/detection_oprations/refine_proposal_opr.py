...
def postprocess_detctions(refine_bbox_pred, refine_cls_prob, anchors, is_training, gpu_id):
    ...
    for j in range(0, cfgs.CLASS_NUM):
        indices = filter_detections(boxes_pred, refine_cls_prob[:, j], is_training, gpu_id)
